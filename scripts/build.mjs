...
const file = "remark-breaks"
const banner = "/*! @itslil/remark-breaks 4.0.1 | LilScript reimplementation of remark-breaks | MIT */\n"
...
await esbuild({
  ...
  bundle: true,
  format: "iife",
  globalName: "remarkBreaks",
  footer: {
    js: `globalThis.remarkBreaks=remarkBreaks.default||remarkBreaks.remarkBreaks||remarkBreaks;`,
  },
  legalComments: "none",
  minifyWhitespace: true,
  minifyIdentifiers: false,
