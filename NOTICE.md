...
`@itslil/remark-breaks` is an independent LilScript reimplementation of
[`remark-breaks`](https://github.com/remarkjs/remark-breaks). It is not affiliated with or
